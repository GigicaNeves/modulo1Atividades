...
| ------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1       | a) A saída será undefined seguido de erro                                        | O código retorna `undefined`, pois a variável `x` é chamada antes de ser declarada. Posteriormente, o erro "Cannot access 'y' before initialization" indica que não é possível acessar a variável `y` antes de sua inicialização. Isso ocorre pelos diferentes escopos de var e let, que apresentam comportamentos diferentes dentro do javascript                                                                        |
